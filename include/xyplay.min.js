    ...
    xyplayer.prototype = {
            ...
            switch (this.tp) {
                ...
                case 'url':
                   ...
                   if (this.play.off.jmp === '1' || this.play.off.yun === '0') {
                        ...
                        } else if (this.play.off.link === '1' && this.tp === "url") {
                            this.Getvideobyurl();          //对接
            ...
            switch (code) {
             ...
             /* 本地数据查询成功 */
                ...
                case 4:
                    ...
                    //检查线路列表图标
                    if (this.play.style.logo_show === "1") {$(console.logo).show(); }
                    break;
                /*  搜索视频成功(id,flag) */
                case 5:
                   ...
                   // console.log(data);
                    ...
                    var video= this.playlist_array[this.part];
                     this.onflag = 'list';
                      ...
                      //调用播放
                    if(this.lsplay('play', video) || this.onflag ==='list'){
 
                      this.AutoPlay('list', video, data.type);

                    }else{
                       $this.onflag = 'line';
                       this.AutoPlay('line', video); 
                    }
        ...
        getvideo: function (type, val, get,obj) {
            ...
            $.ajax({
                ...
                localStorage.setItem('video',data.url);
            ...
            switch (type) {
                ...
                case 'url':
                    ...
                    if (urljmp !== '') {
                        ...
                        console.log("当前播放(URL指定线路)：" + urljmp + url);
                        return true;
                    }
                ...
                case 'flag':
                    ...
                    if (flagjmp !== '') {
                        ...
                        console.log("当前播放(标签指定线路)：" + flagjmp + url);
                        return true;
                    }
        ...
        AutoPlay: function (type, url, play) {
            ...
            switch (type) {
                ...
                case 'line':
                    ...
                    url = url || this.url || this.playlist_array[this.part]|| localStorage.getItem('video');   
                     console.log("播放列表:"+url);
                   
                 if(!this.testplay('url', url)){
                         this.jxplay(this.myurl, url);
                  }
     ...
     /*   内部函数：取伪静态参数  */
        getlocId:function () {
            var reg=/^index(\d+)-(\d+)(?:-|)(?:(\d+|)).*?$/i;
            var r=reg.exec(window.location.search.substr(1));
            if (r !== null) {return {id:r[1],flag:r[2],part:r[3]};};
            return false; 
        },
